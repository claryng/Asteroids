...
class AsteroidsTest {
    ...
    @Test 
    void testSplit() {
        // Test Large Asteroid: If a large asteroid is hit, it splits into two medium asteroids
        asteroid = new LargeAsteroids(game);
        ...
        // Test Medium Asteroid: If a medium asteroid is hit, it splits into two small asteroids
